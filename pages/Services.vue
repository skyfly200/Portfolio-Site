...
.services.skill
  ...
  .services-info
    h2.header IT, Tutoring and Consulting Services
    v-container
      v-row
        v-col(cols="12" md="6")
          v-card
      ...
      v-row
        v-col(cols="12" md="6")
          v-card
            ...
            v-card-text(height="10em")
              | I offer personalized tutoring services in various IT and software development topics, including programming languages (Python, JavaScript, etc.), web development, database management, and cloud computing. My tutoring sessions are tailored to meet the individual needs of each student.
            v-card-actions.card-actions
