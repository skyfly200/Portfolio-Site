  ...
  .topics-container
    .topics
      ...
      @media (max-width: 380px)
        ...
        #front-end .topic-full .github-button button
          min-width: 240px
          font-size: 1.3em
        ...
        #dev-ops .topic-full .projects-list .github-button button
          //font-size: 0.8em
