...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { src: "/images/photography/best/img (13).jpg", title: "Road to Heaven", description: "Matajur peak in Italy" },
      ...
      { src: "/images/photography/best/img (18).jpg", title: "Flight Over Normandy", description: "80th anniversary of D-Day" },
