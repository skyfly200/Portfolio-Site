    ...
    .welcome-block
      .welcome-content.px-5
        ...
        .welcome-blurb(data-aos="fade" data-aos-delay="100")
          ...
          //- p(v-if="false") During my time at King's I had the rare opportunity to intern with Rob Savoy — a true open-web pioneer. Rob is the person behind the GNU Flash player for Linux, a project that made Flash-based sites like YouTube actually usable on Linux at a time when that support simply didn't exist. He also sold his media work to Red Hat Linux and spent years pushing the boundaries of what open-source software could do for everyday users. His server, welcomehome.org, was one of the first sites on the Internet running Apache HTTP Server, and working with him on publishing and HTTP infrastructure gave me a front-row seat to the early web in a way very few people my age ever got.
        .bio-link.pa-7
